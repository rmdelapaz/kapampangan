...
(function () {
    ...
    var K_PROGRESS = 'kapampangan-int-progress';   // { "1": {completed, visited, ts}, ... }
    var K_KNOWN    = 'kapampangan-int-known';      // legacy flat map { "salamat": ts, ... } — migrated into SRS
    var K_SRS      = 'kapampangan-int-srs';        // { "salamat": {box,due,reps}, ... }
    var K_JOURNAL  = 'kapampangan-int-journal:';   // + page slug
    ...
    var TOTAL_LESSONS = (function () {
        try {
            var t = (window.KAPAMPANGAN_INT_VOCAB && window.KAPAMPANGAN_INT_VOCAB.titles) || {};
    ...
    var VOCAB = window.KAPAMPANGAN_INT_VOCAB || {};
    var TITLES = (VOCAB.titles) || {};
    var LESSON_INFO = window.KAPAMPANGAN_INT_LESSON_INFO || {};
    ...
    /* ---------- spaced-repetition store (Leitner boxes) ----------
       kapampangan-int-srs: { "<kp>": { box: 1..5, due: <ts>, reps: <n> } }
       ...
       occasional. The older flat kapampangan-int-known map is migrated in on first read. */
    var DAY = 86400000;
