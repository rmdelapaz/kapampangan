...
(function () {
    ...
    var K_PROGRESS = 'kapampangan-progress';   // { "1": {completed, visited, ts}, ... }
    var K_KNOWN    = 'kapampangan-known';      // legacy flat map { "salamat": ts, ... } — migrated into SRS
    var K_SRS      = 'kapampangan-srs';        // { "salamat": {box,due,reps}, ... }
    var K_JOURNAL  = 'kapampangan-journal:';   // + page slug
    ...
    var TOTAL_LESSONS = (function () {
        try {
            var t = (window.KAPAMPANGAN_VOCAB && window.KAPAMPANGAN_VOCAB.titles) || {};
    ...
    var VOCAB = window.KAPAMPANGAN_VOCAB || {};
    var TITLES = (VOCAB.titles) || {};
    var LESSON_INFO = window.KAPAMPANGAN_LESSON_INFO || {};
    ...
    /* ---------- spaced-repetition store (Leitner boxes) ----------
       kapampangan-srs: { "<kp>": { box: 1..5, due: <ts>, reps: <n> } }
       ...
       occasional. The older flat kapampangan-known map is migrated in on first read. */
    var DAY = 86400000;
